...
whatever the servant could dream up. 
Knowing that the king loved chess, the servant told the king he would like to have grains of wheat. 
One grain on the first square of a chess board, with the number of grains doubling on 
...
meaningful error message to indicate what the source of the error is. 
...
when the square input is out of range. 
